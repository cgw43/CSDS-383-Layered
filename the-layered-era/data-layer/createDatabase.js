...
function createDB() { 
    ...
    let createDatabaseQuery = `SELECT 'CREATE DATABASE postgres'
    ...
    pgClient.query(createTablesAndFunctionsQueries.join(' '), (err, result) => {
        if (err) {
            console.error('Error creating tables and functions:', err);
        } else {
            console.log("Successfully created relations & functions");
        }
